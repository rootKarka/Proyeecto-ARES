...
export default function RobotForm({ initial, onSubmit, onCancel, loading }) {
  const [form, setForm] = useState(
    initial
      ? { nombre: initial.nombre, estado: initial.estado, latitud: initial.latitud, longitud: initial.longitud }
      : { nombre: "", estado: "Activo", latitud: "", longitud: "" }
  );
  ...
  // CORRECCIÓN: focus:ring-blue-500 en lugar de violet-500
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-3 pt-2">
        ...
        <button
          type="submit"
          disabled={loading}
          // CORRECCIÓN: bg-blue-600 hover:bg-blue-700 (claro) y bg-blue-500 hover:bg-blue-600 (oscuro) en lugar de violet
